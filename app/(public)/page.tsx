...
const Stats        = dynamic(() => import('@/components/landing/Stats'),        { loading: () => <StatsSkeleton />,        ssr: false });
const Marquee      = dynamic(() => import('@/components/landing/Marquee'),      { loading: () => <MarqueeSkeleton />,      ssr: false });
const Services     = dynamic(() => import('@/components/landing/Services'),     { loading: () => <ServicesSkeleton />,     ssr: false });
const Process      = dynamic(() => import('@/components/landing/Process'),      { loading: () => <ProcessSkeleton />,      ssr: false });
const CaseStudies  = dynamic(() => import('@/components/landing/CaseStudies'),  { loading: () => <CaseStudiesSkeleton />,  ssr: false });
const Testimonials = dynamic(() => import('@/components/landing/Testimonials'), { loading: () => <TestimonialsSkeleton />, ssr: false });
const Faq          = dynamic(() => import('@/components/landing/Faq'),          { loading: () => <FaqSkeleton />,          ssr: false });
const CtaStrip     = dynamic(() => import('@/components/landing/CtaStrip'),     { loading: () => <CtaStripSkeleton />,     ssr: false });
